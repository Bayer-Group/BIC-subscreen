  ...
  output$legend <- shiny::renderUI({
    ...
    if (!rowwise) {
      ...
      shiny::tagList(
            ...
            shiny::span(
              shiny::tagList(
                shiny::tags$i(
                  ...
                  style = paste0(
                    "color: rgba(",
                    grDevices::col2rgb(colour[2])[1],
                    ",",
                    grDevices::col2rgb(colour[2])[2],
                    ",",
                    grDevices::col2rgb(colour[2])[3],
                    ",",
                    0.75,
                    ")"
                  )
            ...
            shiny::span(
              shiny::tagList(
                shiny::tags$i(
                  ...
                  style = paste0(
                    "color: rgba(",
                    grDevices::col2rgb(colour[3])[1],
                    ",",
                    grDevices::col2rgb(colour[3])[2],
                    ",",
                    grDevices::col2rgb(colour[3])[3],
                    ",",
                    0.5,
                    ")"
                  )
            ...
            shiny::span(
              shiny::tagList(
                shiny::tags$i(
                  ...
                  style = paste0(
                    "color: rgba(",
                    grDevices::col2rgb(colour[4])[1],
                    ",",
                    grDevices::col2rgb(colour[4])[2],
                    ",",
                    grDevices::col2rgb(colour[4])[3],
                    ",",
                    0.25,
                    ")"
                  )
            ...
            shiny::span(
              shiny::tagList(
                shiny::tags$i(
                  ...
                  style = paste0(
                    "color: rgba(",
                    grDevices::col2rgb(colour[5])[1],
                    ",",
                    grDevices::col2rgb(colour[5])[2],
                    ",",
                    grDevices::col2rgb(colour[5])[3],
                    ",",
                    0.1,
                    ")"
                  )
        ...
        if (
          different_hues(colthemeCol()$ColorFactCont, value = 50) %in%
            plot_color()
        ) {
          tag <- shiny::p(
            shiny::span(
              shiny::tagList(
                shiny::tags$i(
                  ...
                  style = paste0(
                    "color: ",
                    different_hues(colthemeCol()$ColorFactCont, value = 50)
                  )
                ),
        ...
        if (
          different_hues(colthemeCol()$ColorFactCont, value = 150) %in%
            plot_color()
        ) {
          tag <- shiny::p(
            shiny::span(
              shiny::tagList(
                shiny::tags$i(
                  ...
                  style = paste0(
                    "color: ",
                    different_hues(colthemeCol()$ColorFactCont, value = 150)
                  )
                ),
        ...
        if (
          different_hues(colthemeCol()$ColorFactCont, value = 100) %in%
            plot_color()
        ) {
          tag <- shiny::p(
            shiny::span(
              shiny::tagList(
                shiny::tags$i(
                  ...
                  style = paste0(
                    "color: ",
                    different_hues(colthemeCol()$ColorFactCont, value = 100)
                  )
                ),
          ...
          shiny::span(
            shiny::tagList(
              shiny::tags$i(
                ...
                style = paste0(
                  "color: rgba(",
                  grDevices::col2rgb(colour[1])[1],
                  ",",
                  grDevices::col2rgb(colour[1])[2],
                  ",",
                  grDevices::col2rgb(colour[1])[3],
                  ",",
                  1,
                  ")"
                )
